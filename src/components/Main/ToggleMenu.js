...
import { ToggleMenuPropTypes, ToggleMenuDefaultProps } from './Main.props'
  ...
  render() {
    ...
    return menuMode === baseType.MENU_MODE_ICON ? (
      <Menu large className='bitfinex-compact-menu hidden-xs hidden-sm hidden-md'>
        <Timeframe handleClickCustom={handleClickCustom} />
        <MenuDivider />
        <MenuItem
...
ToggleMenu.propTypes = ToggleMenuPropTypes
ToggleMenu.defaultProps = ToggleMenuDefaultProps
