...
const FundingCreditHistory = () => {
  ...
  useFetchLifecycle(TYPE, {
    ...
    dataReceived,
    isSyncRequired,
    fetchData: () => dispatch(fetchFCredit()),
