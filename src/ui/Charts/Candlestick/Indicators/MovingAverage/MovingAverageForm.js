...
import { propTypes, defaultProps } from './MovingAverageForm.props'

class MovingAverageForm extends React.PureComponent {
  constructor(props) {
    super()
    this.state = {
...
MovingAverageForm.propTypes = propTypes
MovingAverageForm.defaultProps = defaultProps

export default withTranslation('translations')(MovingAverageForm)
