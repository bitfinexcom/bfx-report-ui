...
const LedgersCategoriesSelect = (props) => {
  const {
    className,
    onChange,
    t,
...
LedgersCategoriesSelect.propTypes = {
...
LedgersCategoriesSelect.defaultProps = {
  className: '',
}

export default withTranslation('translations')(LedgersCategoriesSelect)
